...
ADMINS = int(environ.get("ADMINS", "5683891175"))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001915187457')).split()]
...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1001915187457'))
    ...
    if HAS_SSL:
        URL = "https://pathan-public-store-7035eaa9d8a8.herokuapp.com/"
    else:
        URL = "https://pathan-public-store-7035eaa9d8a8.herokuapp.com/"
